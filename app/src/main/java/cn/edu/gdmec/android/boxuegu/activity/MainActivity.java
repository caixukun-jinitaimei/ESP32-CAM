...
import cn.edu.gdmec.android.boxuegu.fragment.MonitorFragment;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener{
    ...
    private TextView bottom_bar_text_monitor;
    private ImageView bottom_bar_image_monitor;
    private RelativeLayout bottom_bar_monitor_btn;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Toast.makeText(MainActivity.this, "再按一次退出EDU", Toast.LENGTH_SHORT).show();
    ...
    private void setSelectStatus(int index) {
        switch (index){
            case 0:
                ...
                bottom_bar_text_monitor.setTextColor(Color.parseColor("#666666"));
                ...
                bottom_bar_image_monitor.setImageResource(R.drawable.main_monitor_icon);
                getSupportFragmentManager().beginTransaction().replace(R.id.main_body,new CourseFragment()).commit();
                tv_main_title.setText("EDU课程");
                break;
            case 1:
            ...
            case 2:
                ...
                tv_main_title.setText("EDU");
                break;
            case 3:
                bottom_bar_image_myinfo.setImageResource(R.drawable.main_monitor_icon_selected);
                bottom_bar_text_monitor.setTextColor(Color.parseColor("#0097F7"));
                bottom_bar_text_course.setTextColor(Color.parseColor("#666666"));
                bottom_bar_text_exercises.setTextColor(Color.parseColor("#666666"));
                bottom_bar_text_myinfo.setTextColor(Color.parseColor("#666666"));
                bottom_bar_image_myinfo.setImageResource(R.drawable.main_my_icon);
                bottom_bar_image_exercises.setImageResource(R.drawable.main_exercises_icon);
                bottom_bar_image_course.setImageResource(R.drawable.main_course_icon);
                getSupportFragmentManager().beginTransaction().replace(R.id.main_body,new MonitorFragment()).commit();
                tv_main_title.setText("EDU远程监控");
                break;
        }
    }
    private void initView() {
        ...
        bottom_bar_text_monitor = findViewById(R.id.bottom_bar_text_monitor);
        bottom_bar_image_monitor = findViewById(R.id.bottom_bar_image_monitor);
        bottom_bar_monitor_btn = findViewById(R.id.bottom_bar_monitor_btn);
        ...
        bottom_bar_monitor_btn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.bottom_bar_myinfo_btn:
                ...
                setSelectStatus(2);
                break;
            case R.id.bottom_bar_monitor_btn:
                setSelectStatus(3);
                break;
        }
    }
